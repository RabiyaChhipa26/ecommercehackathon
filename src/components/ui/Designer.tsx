...
const Designer = () => {
    return (
        <div className="px-1 lg:mt-20">

            {/* top */}
            <div className="flex justify-start md:justify-end text-3xl md:text-4xl font-bold py-4 ">
                <h4 className="max-w-[27rem]">Unique and Authentic Vintage Designer Jewellery</h4>
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-between py-4 mt-2 gap-5">
                ...
                <div className="relative basis-1/2  gap-6 lg:gap-10 grid grid-cols-2 grid-rows-2">
                    <div className="absolute -z-50 text-gray-200 inset-0">
                ...
                <div className="flex flex-col lg:flex-row basis-1/2">
                    ...
                    <div className="space-y-2 md:space-y-2 p-4">
                        ...
                        <button className="text-white bg-gray-900 rounded-md DesignerSection p-2.5">See All Products</button>
                    </div>
                </div>
